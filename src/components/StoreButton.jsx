    ...
    <>
      ...
      {showStore && (
        <section className="hidden">
          ...
          <div
            onClick={() => handlePurchase(10, "/Images/Cookies/second.webp")}
          >
            <img
              style={divStyle}
              ...
              id="selectedImg1"
              src="/Images/Cookies/second.webp"
              alt="Picture 1"
            />
            <p id="Cost1">Cost: 10 cookies</p>
          </div>

          <div onClick={() => handlePurchase(20, "/Images/Cookies/third.png")}>
            <img
              style={divStyleTwo}
              onMouseEnter={() => setIsHoveredTwo(true)}
              onMouseLeave={() => setIsHoveredTwo(false)}
              id="selectedImg2"
              src="/Images/Cookies/third.png"
              alt="Picture 2"
            />
            <p id="Cost2">Cost: 20 cookies</p>
          </div>

          <div onClick={() => handlePurchase(0, "/Images/Cookies/first.webp")}>
            <img
              style={divStyleThree}
